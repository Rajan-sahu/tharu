...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2025 at 01:06 PM
...
INSERT INTO `sh_admin` (`id`, `name`, `email`, `password`) VALUES
(1, 'admin', 'admin@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef'),
(2, 'suzuka', 'suzuka@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef');
...
--
-- Table structure for table `zuraud_department`
--

CREATE TABLE `zuraud_department` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `zuraud_designation`
--

CREATE TABLE `zuraud_designation` (
  `id` int(11) NOT NULL,
  `title` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `zuraud_designation`
--

INSERT INTO `zuraud_designation` (`id`, `title`) VALUES
(1, 'Administrator'),
(2, 'Sweeper'),
(3, 'ds');
...
--
-- Table structure for table `zuraud_employee`
--

CREATE TABLE `zuraud_employee` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `zuraud_shift`
--

CREATE TABLE `zuraud_shift` (
  `id` int(11) NOT NULL,
  `name` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `zuraud_shift`
--

INSERT INTO `zuraud_shift` (`id`, `name`, `start_time`, `end_time`) VALUES
(1, 'Morning', '08:00:00', '16:00:00'),
(2, 'Afternoon', '08:00:00', '14:40:00');

-- --------------------------------------------------------

--
-- Table structure for table `zuraud_station`
--

CREATE TABLE `zuraud_station` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `zuraud_station`
--

INSERT INTO `zuraud_station` (`id`, `station_name`, `address`, `latitude`, `longitude`, `state`, `city`) VALUES
(3, 'test df', 'retg df', '12.928203099264772', '81.862666', 23, 516),
(4, 'fsdf', 'SADF', '23.0637807N', '88.3152336177934', 2, 1);
...
--
-- Indexes for table `zuraud_department`
--
ALTER TABLE `zuraud_department`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zuraud_designation`
--
ALTER TABLE `zuraud_designation`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zuraud_employee`
--
ALTER TABLE `zuraud_employee`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zuraud_shift`
--
ALTER TABLE `zuraud_shift`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `zuraud_station`
--
ALTER TABLE `zuraud_station`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `zuraud_department`
--
ALTER TABLE `zuraud_department`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `zuraud_designation`
--
ALTER TABLE `zuraud_designation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `zuraud_employee`
--
ALTER TABLE `zuraud_employee`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `zuraud_shift`
--
ALTER TABLE `zuraud_shift`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `zuraud_station`
--
ALTER TABLE `zuraud_station`
