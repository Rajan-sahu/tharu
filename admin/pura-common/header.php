<?php 
  if (!isset($_SESSION['admin_id']) || empty($_SESSION['admin_id'])){
    ...
    $select_admin = $_SESSION['admin_id'];

    $query = "SELECT * FROM sh_admin WHERE id = $select_admin";
                            ...
                            <li class="nav-item dropdown custom-drop">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title"><?= ucwords($row_admin['name']);?></h6>
                                        <p class="mb-0 caption-sub-title"><?= $row_admin['email'];?></p>
                                    </div>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Hello, <?= ucwords($row_admin['name']);?></h1>
