 <?php
   ...
   if (!empty($update_id)) {
      ...
      try {
         $updatequery = "UPDATE `zuraud_employee` SET `name` = '$name', `f_name` = '$f_name', `gender` = '$gender', `dob` = '$dob', `mobile_no` = '$mobile_no', `doj` = '$doj', `doe` = '$doe', `station` = '$station', `department` ='$department', `designation` = '$designation', `shift` = '$shift' WHERE `id` = '$update_id' ";
      ...
      try {
         $insertquery = "INSERT INTO `zuraud_employee`( `name`, `f_name`,`gender`,`dob`,`doj`,`doe`,`mobile_no`,`station`,`department`,`designation`,`shift`) VALUES ('$name', '$f_name','$gender','$dob','$doj','$doe','$mobile_no','$station','$department','$designation','$shift')";
