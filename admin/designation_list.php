...
<div class="container-fluid content-inner mt-n5">
   <div class="card shadow-lg border-0 rounded-3">
      <div class="card-header d-flex justify-content-between align-items-center">
         ...
         <a href="designation_add.php" class="btn btn-sm btn-primary">
      ...
      <div class="card-body">
         <?php
         $designations = [];
         $sql = "SELECT * FROM zuraud_designation ";
                     ...
                     <?php foreach ($designations as $index => $designation) { ?>
                        <tr>
                           ...
                           <td class="text-center">
                              <a title="Edit" href="designation_add.php?id=<?= $designation['id'] ?>" class="btn btn-sm btn-outline-primary me-1">
                                 <i class="fas fa-edit"></i>
                              </a>
                              <a title="Delete" href="#" class="btn btn-sm btn-outline-danger delete-designation" data-del_id=<?= $designation['id'] ?>>
